...
window.SBL_LESSONS['FH-t1-l1-global-patterns'] = {
  ...
  quiz: [
    { q: 'Health is best defined as:', options: ['The complete absence of disease only', 'A state of complete physical, mental and social wellbeing, not merely the absence of disease', 'A term that only applies to physical fitness, excluding any mental or social dimension of wellbeing', 'A fixed characteristic that cannot change over time'], correct: 1, explain: 'Health is widely defined as a state of complete physical, mental and social wellbeing, not simply the absence of disease or infirmity.', misconception: 'Health is sometimes reduced to just "not being sick," when it is a broader concept encompassing physical, mental and social wellbeing together.', tag: 'What is health?' },
  ...
  "quiz": [
    {
      ...
      "options": [
        "Setting binding international health regulations for all countries, rather than delivering food assistance, regardless of season or location.",
    ...
    },
    {
      ...
      "options": [
        ...
        "The FAO only operates in high-income countries, rather than focusing on technical agricultural support, regardless of any other environmental or economic factor involved.",
    ...
    },
    {
      ...
      "options": [
        ...
        "Distribute emergency food parcels directly to affected households, rather than coordinating disease responses",
    ...
    },
    {
      ...
      "options": [
        ...
        "Restrict food trade between countries, rather than tackling hunger through agricultural development funding, regardless of location.",
    ...
    },
    {
      ...
      "options": [
        ...
        "It doubled its funding for global food security programmes, rather than being dissolved into the State Department, regardless of any other social, economic or environmental factor that might be involved in a specific place.",
    ...
    },
    {
      ...
      "options": [
        ...
        "Setting international trade tariffs, rather than delivering emergency relief and campaigning on poverty, regardless of location.",
    ...
    },
    {
      ...
      "options": [
        "Adult employment programmes only, rather than child-focused nutrition, health and education support, regardless of location.",
    ...
    },
    {
      ...
      "options": [
        "Have unlimited funding with no constraints, rather than depending on donor governments and the public, according to most published research on the topic.",
    ...
    },
    {
      ...
      "options": [
        ...
        "Only the size of its annual budget, rather than its measurable impact on food security or health outcomes, according to most published research on the topic.",
  ...
  "quiz": [
    {
      ...
      "options": [
        ...
        "A government department responsible for agricultural policy, rather than a large-scale industrialised business, regardless of any other environmental or economic factor involved.",
    ...
    },
    {
      ...
      "options": [
        ...
        "Only ever operating in a single country, rather than owning multiple stages of the supply chain itself, regardless of location.",
    ...
    },
    {
      ...
      "options": [
        ...
        "Only selling products directly to farmers, rather than merging with competitors at the same production stage, regardless of location.",
    ...
    },
    {
      ...
      "options": [
        ...
        "They receive no scrutiny from any government, rather than benefiting from economies of scale in production, regardless of location.",
    ...
    },
    {
      ...
      "options": [
        ...
        "Refusing to advertise their products at all, rather than using advertising and branding to shape preferences",
    ...
    },
    {
      ...
      "options": [
        ...
        "A measure of a country's total food production, rather than the right to define one's own food systems, regardless of any other social, economic or environmental factor that might be involved in a specific place.",
    ...
    },
    {
      ...
      "options": [
        ...
        "Having no effect on local food systems whatsoever, rather than encouraging dependency on TNC-supplied inputs, regardless of season or location.",
    ...
    },
    {
      ...
      "options": [
        ...
        "Complete elimination of consumer choice, rather than greater variety, convenience and lower prices",
    ...
    },
    {
      ...
      "options": [
        ...
        "Complete elimination of food advertising, rather than increased availability of processed, energy-dense foods, regardless of season or location.",
    ...
    },
    {
      ...
      "options": [
        ...
        "Guaranteed increased profits for every local producer, rather than a mix of potential benefits and harms, a pattern confirmed by decades of consistent geographic observation and measurement.",
...
window.SBL_LESSONS.FH13 = {
  ...
  "quiz": [
    ...
    },
    {
      ...
      "options": [
        "Guaranteed equal access to land and credit for men and women in all countries, contrary to actual gender gaps, regardless of any other environmental or economic factor involved.",
    ...
    },
    {
      ...
      "options": [
        ...
        "Reduce global agricultural output significantly, rather than eliminating yield gaps and reducing hunger, regardless of any other environmental or economic factor involved.",
    ...
    },
    {
      ...
      "options": [
        ...
        "There is no measurable effect on children, rather than a 20% rise in children's chances of survival, regardless of location.",
    ...
    },
    {
      ...
      "options": [
        ...
        "Free and unrestricted healthcare access for all women, rather than facing a shortage of female doctors, regardless of any other social, economic or environmental factor that might be involved in a specific place.",
    ...
    },
    {
      ...
      "options": [
        ...
        "Exactly the same as men in every country, rather than earning around 23% less than men on average globally",
    ...
    },
    {
      ...
      "options": [
        ...
        "Masculinity has no connection to health-seeking behaviour anywhere in the world, contrary to social norms, a claim not supported by any of the case study evidence examined in this unit or by wider published geographical research on the topic.",
    ...
    },
    {
      ...
      "options": [
        ...
        "Reduce funding for all women's education programmes, rather than tackling discriminatory land ownership laws, a claim not supported by any of the case study evidence examined in this unit or by wider published geographical research on the topic.",
    ...
    },
    {
      ...
      "options": [
        ...
        "Are only relevant to men's health, rather than reducing unplanned pregnancies and empowering women, a pattern confirmed by decades of consistent geographic observation and measurement.",
  ...
  "quiz": [
    {
      ...
      "options": [
        "Exactly the same thing, with no meaningful distinction, rather than an extreme, geographically specific event, regardless of any other environmental or economic factor involved.",
    ...
    },
    {
      ...
      "options": [
        ...
        "Government policy alone, with no physical cause, rather than a physical shortage from drought or pests",
    ...
    },
    {
      ...
      "options": [
        ...
        "Excess food production with no other factors involved, rather than a lack of economic or political means, regardless of any other environmental or economic factor involved.",
    ...
    },
    {
      ...
      "options": [
        ...
        "No countries at all, rather than countries including Yemen, Somalia, Pakistan, Egypt and Indonesia",
    ...
    },
    {
      ...
      "options": [
        ...
        "All countries have unlimited access to fresh water, rather than 2.8 billion people facing water stress, a pattern confirmed by decades of consistent geographic observation and measurement.",
    ...
    },
    {
      ...
      "options": [
        ...
        "Has no effect on crop yields, rather than causing yield losses of 40-100% across infested land in Africa, regardless of any other social, economic or environmental factor that might be involved in a specific place.",
    ...
    },
    {
      ...
      "options": [
        ...
        "All governments respond to famine identically, rather than governance decisions shaping its severity, regardless of any other social, economic or environmental factor that might be involved in a specific place.",
    ...
    },
    {
      ...
      "options": [
        ...
        "Guaranteeing equal aid to every famine, regardless of media coverage, rather than under-reported crises losing out, according to most published research on the topic.",
    ...
    },
    {
      ...
      "options": [
        ...
        "Famine severity is entirely unrelated to aid access, rather than blocked routes worsening its severity, according to the overwhelming weight of available evidence and data.",
  ...
  "quiz": [
    {
      ...
      "options": [
        ...
        "A trade dispute escalated into armed conflict in 2020, rather than Houthi rebels overthrowing the government in 2014, according to most published research on the topic.",
    ...
    },
    {
      ...
      "options": [
        ...
        "All fighting in Yemen ceased entirely, rather than a Saudi-led coalition beginning a military campaign, regardless of any other environmental or economic factor involved.",
    ...
    },
    {
      ...
      "options": [
        ...
        "Increasing everyone's income across the country, rather than destroying livelihoods and disrupting markets, according to most published research on the topic.",
    ...
    },
    {
      ...
      "options": [
        "All health facilities in Yemen remained fully functional throughout the conflict, contrary to the actual collapse, regardless of any other social, economic or environmental factor that might be involved in a specific place.",
    ...
    },
    {
      ...
      "options": [
        ...
        "Measure only rainfall levels, rather than providing a standard scale for classifying food insecurity severity, regardless of season or location.",
    ...
    },
    {
      ...
      "options": [
        ...
        "Only a few thousand people affected nationally, rather than 17 million facing severe food insecurity, regardless of any other environmental or economic factor involved.",
    ...
    },
    {
      ...
      "options": [
        ...
        "Are the wealthiest regions of Yemen with no food insecurity, rather than home to intense ongoing conflict, regardless of location.",
    ...
    },
    {
      ...
      "options": [
        ...
        "A crisis with no identifiable causes at all, rather than a largely human-driven crisis destroying livelihoods, a pattern confirmed by decades of consistent geographic observation and measurement.",
  ...
  "quiz": [
    {
      ...
      "options": [
        ...
        "The entire population of the Arabian Peninsula, rather than 6.8 million people through food assistance",
    ...
    },
    {
      ...
      "options": [
        ...
        "Requiring beneficiaries to travel to a different country to redeem support, rather than local retail outlets, regardless of any other environmental or economic factor involved.",
    ...
    },
    {
      ...
      "options": [
        ...
        "A programme that only accepts children over the age of 10, rather than treating children aged 6 to 59 months",
    ...
    },
    {
      ...
      "options": [
        ...
        "A one-off payment with no follow-up, rather than a monthly ration from the second trimester onward, regardless of any other environmental or economic factor involved.",
    ...
    },
    {
      ...
      "options": [
        ...
        "Which districts have the largest population, regardless of need, rather than a food-insecurity threshold, regardless of any other social, economic or environmental factor that might be involved in a specific place.",
    ...
    },
    {
      ...
      "options": [
        ...
        "Households headed by physically-challenged persons, rather than those with pregnant or lactating women, regardless of any other environmental or economic factor involved.",
    ...
    },
    {
      ...
      "options": [
        ...
        "No difficulties exist in the shorter term, rather than the risk of funding shortfalls forcing hard priorities, a pattern confirmed by decades of consistent geographic observation and measurement.",
    ...
    },
    {
      ...
      "options": [
        ...
        "Humanitarian aid alone has completely eliminated the root causes of the crisis, contrary to continued conflict, regardless of any other social, economic or environmental factor that might be involved in a specific place.",
    ...
    },
    {
      ...
      "options": [
        ...
        "That the scale of need has no bearing on how a crisis is managed, rather than outstripping any single operation, regardless of any other environmental or economic factor involved.",
    ...
    },
    {
      ...
      "options": [
        ...
        "No international involvement of any kind, rather than addressing underlying political and conflict causes, according to most published research on the topic.",
  ...
  "quiz": [
    {
      ...
      "options": [
        ...
        "A synonym for famine, with no distinct meaning, rather than a state of lacking reliable access to food, regardless of season or location.",
    ...
    },
    {
      ...
      "options": [
        ...
        "Food aid has completely eliminated global hunger, rather than the WFP reaching only a fraction of those in need, a pattern confirmed by decades of consistent geographic observation and measurement.",
    ...
    },
    {
      ...
      "options": [
        ...
        "Investment has no effect on crop yields anywhere, rather than potentially quadrupling yields through irrigation, a pattern confirmed by decades of consistent geographic observation and measurement.",
    ...
    },
    {
      ...
      "options": [
        ...
        "All harvested crops reach the market successfully in every country, rather than a third being lost after harvest, regardless of season or location.",
    ...
    },
    {
      ...
      "options": [
        ...
        "Would guarantee an immediate end to global food insecurity with no downsides, rather than helping some and harming others, regardless of any other environmental or economic factor involved.",
    ...
    },
    {
      ...
      "options": [
        ...
        "Have no effect on global markets, rather than driving up prices and increasing market volatility elsewhere, according to most published research on the topic.",
    ...
    },
    {
      ...
      "options": [
        ...
        "GM crops have never been researched anywhere in the world, rather than research focusing mainly on rich countries, regardless of any other social, economic or environmental factor that might be involved in a specific place.",
    ...
    },
    {
      ...
      "options": [
        ...
        "Fertiliser prices have fallen consistently worldwide, rather than rising sharply and threatening future harvests, a pattern confirmed by decades of consistent geographic observation and measurement.",
    ...
    },
    {
      ...
      "options": [
        ...
        "Everyone in the world already eats an identical diet, rather than emerging economies adopting Western diets, a conclusion contradicted by the detailed evidence, data and statistics presented throughout this case study and the wider academic literature on the subject.",
    ...
    },
    {
      ...
      "options": [
        ...
        "Only 1% of food is wasted worldwide, a negligible amount, rather than up to a third of the world's food, a claim not supported by any of the case study evidence examined in this unit or by wider published geographical research on the topic.",
  ...
  "quiz": [
    {
      ...
      "options": [
        ...
        "Has no connection to farmer income or food supply, rather than putting environmental resources first, a pattern confirmed by decades of consistent geographic observation and measurement.",
    ...
    },
    {
      ...
      "options": [
        ...
        "It has since been completely reversed in every country, rather than still shaping food production debates, a claim not supported by any of the case study evidence examined in this unit or by wider published geographical research on the topic, a conclusion contradicted by the detailed evidence, data and statistics presented throughout this case study and the wider academic literature on the subject.",
    ...
    },
    {
      ...
      "options": [
        ...
        "Removing the need for water in crop production entirely, rather than using solar-powered pumps to distribute it, a pattern confirmed by decades of consistent geographic observation and measurement.",
    ...
    },
    {
      ...
      "options": [
        ...
        "Genetically modifying live animals to grow larger, rather than culturing animal cells in a laboratory setting, regardless of location.",
    ...
    },
    {
      ...
      "options": [
        ...
        "Removing the need for water in crop production, rather than growing crops without soil to increase yield, regardless of any other environmental or economic factor involved.",
    ...
    },
    {
      ...
      "options": [
        ...
        "GM crops always reduce yields compared to non-GM varieties, rather than improving resistance or increasing yields, regardless of location.",
    ...
    },
    {
      ...
      "options": [
        ...
        "GM crops are illegal to grow in every country, rather than raising concerns over seed patents and biodiversity, regardless of any other social, economic or environmental factor that might be involved in a specific place.",
    ...
    },
    {
      ...
      "options": [
        ...
        "Physically watering crops from space, rather than remotely monitoring crop health, soil moisture and yield, regardless of any other environmental or economic factor involved.",
    ...
    },
    {
      ...
      "options": [
        ...
        "Rice cannot be genetically modified, rather than adapting through drought-tolerant varieties and remote sensing, regardless of any other social, economic or environmental factor that might be involved in a specific place.",
    ...
    },
    {
      ...
      "options": [
        ...
        "Rice production requires no water at all, rather than having one of the highest water footprints of staple crops, regardless of any other environmental or economic factor involved.",
  ...
  "quiz": [
    {
      ...
      "options": [
        ...
        "Has no role in any healthcare system, rather than treating disease and illness after it has already developed, regardless of location.",
    ...
    },
    {
      ...
      "options": [
        ...
        "Has no limitations of any kind, rather than being more expensive per person and not reducing new case rates, a pattern confirmed by decades of consistent geographic observation and measurement.",
    ...
    },
    {
      ...
      "options": [
        ...
        "Replacing the need for any hospitals, rather than preventing disease through vaccination and screening, regardless of season or location.",
    ...
    },
    {
      ...
      "options": [
        ...
        "Is always more expensive than curative care, rather than being more cost-effective in the long term, according to most published research on the topic.",
    ...
    },
    {
      ...
      "options": [
        ...
        "It is only relevant to non-communicable diseases, rather than requiring sustained investment and engagement, regardless of any other social, economic or environmental factor that might be involved in a specific place.",
    ...
    },
    {
      ...
      "options": [
        "Marginalised groups always have equal access to healthcare as everyone else, contrary to actual reduced access, regardless of any other social, economic or environmental factor that might be involved in a specific place.",
    ...
    },
    {
      ...
      "options": [
        "All governments allocate identical healthcare budgets with no variation, rather than differing based on priorities, regardless of any other social, economic or environmental factor that might be involved in a specific place.",
    ...
    },
    {
      ...
      "options": [
        ...
        "Only ever being relevant to prevention, never treatment, rather than providing tools for both approaches, regardless of any other social, economic or environmental factor that might be involved in a specific place.",
    ...
    },
    {
      ...
      "options": [
        ...
        "Only private for-profit companies with no charitable involvement, rather than an NGO working with local authorities, regardless of location.",
  ...
  "quiz": [
    {
      ...
      "options": [
        ...
        "A disease that only ever affects animals, rather than an outbreak spreading across multiple countries, according to most published research on the topic.",
    ...
    },
    {
      ...
      "options": [
        ...
        "A term unrelated to viruses, rather than small, gradual genetic mutations allowing partial immune evasion, regardless of location.",
    ...
    },
    {
      ...
      "options": [
        ...
        "The physical transport of a virus by international travellers, rather than a sudden, major genetic change, a claim not supported by any of the case study evidence examined in this unit or by wider published geographical research on the topic.",
    ...
    },
    {
      ...
      "options": [
        ...
        "Ebola cannot be transmitted between humans at all, rather than spreading through contact with bodily fluids, regardless of any other social, economic or environmental factor that might be involved in a specific place.",
    ...
    },
    {
      ...
      "options": [
        ...
        "The incubation period guarantees symptoms appear within hours, rather than allowing weeks of travel before symptoms, according to most published research on the topic.",
    ...
    },
    {
      ...
      "options": [
        ...
        "International health authorities were alerted within days of the first case, rather than after months of delay, a claim not supported by any of the case study evidence examined in this unit or by wider published geographical research on the topic.",
    ...
    },
    {
      ...
      "options": [
        ...
        "It only ever affected rural areas, never reaching any capital cities, rather than spreading into dense cities, regardless of any other social, economic or environmental factor that might be involved in a specific place.",
    ...
    },
    {
      ...
      "options": [
        ...
        "No residents living in the area at the time, rather than very high population density and poor sanitation, regardless of any other social, economic or environmental factor that might be involved in a specific place.",
    ...
    },
    {
      ...
      "options": [
        ...
        "International organisations refusing to send any support to the affected region, rather than deploying aid, a claim not supported by any of the case study evidence examined in this unit or by wider published geographical research on the topic, a conclusion contradicted by the detailed evidence, data and statistics presented throughout this case study and the wider academic literature on the subject.",
    ...
    },
    {
      ...
      "options": [
        ...
        "Relying solely on curative treatment with no preventative or community engagement measures, contrary to the lessons, a conclusion contradicted by the detailed evidence, data and statistics presented throughout this case study and the wider academic literature on the subject.",
