...
window.SBL_LESSONS.CP03 = {
  ...
  challenge: {
    question: 'To what extent are inequalities caused by decisions made by people rather than physical geography?',
    intro: 'This is not an essay question — it is designed to promote your own thinking. Decide where you stand, then weigh human decisions (government investment, infrastructure spending, migration policy, trade and development choices) against physical factors (location, climate, natural resources, terrain) to build a justified case for how far Thailand’s core-periphery inequality is really down to people rather than physical geography.'
  }
};
