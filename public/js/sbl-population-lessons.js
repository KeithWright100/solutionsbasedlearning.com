...
window.SBL_LESSONS.CP01 = {
  ...
  readinessQuestions: [
    ...
    { q: 'A choropleth map shows population data using:', options: ['One dot per fixed number of people', 'Shaded regions representing value ranges', 'Arrows showing migration flows', 'Contour lines'], correct: 1, explain: 'Choropleth maps use colour shading across defined areas to represent data ranges; dot maps use dots to represent set quantities.', misconception: 'Choropleth and dot maps are often mixed up because both display density-related data, but their visual method is different.', tag: 'Choropleth vs dot maps' },
...
window.SBL_LESSONS.CP02 = {
  ...
  readinessQuestions: [
    ...
    { q: 'Which is a common global pattern of development?', options: ['Development is identical in every country', 'A general divide between more and less developed regions', 'All LICs are in the Southern Hemisphere', 'Development never changes over time'], correct: 1, explain: 'While patterns are complex, there is a broad global pattern of unevenness between more and less developed regions.', misconception: 'Assuming all LICs sit neatly in one hemisphere oversimplifies a genuinely complex and changing global pattern.', tag: 'Global development patterns' },
...
window.SBL_LESSONS.CP03 = {
  ...
  readinessQuestions: [
    ...
    { q: 'Bangkok\u2019s rapid growth is mainly linked to:', options: ['Its status as a periphery region', 'Concentration of jobs, services and investment', 'A government policy limiting its size', 'Its remote, undeveloped location'], correct: 1, explain: 'Bangkok has grown due to concentrated economic activity, employment opportunities and infrastructure investment.', misconception: 'Some students mistakenly describe Bangkok as peripheral because it is a single city, rather than recognising it as Thailand\u2019s clear economic core.', tag: 'Why Bangkok grows' },
    { q: 'A peripheral region within Thailand is most likely to have:', options: ['High investment and dense population', 'Lower investment, services, and population density than Bangkok', 'The same population density as Bangkok', 'No population at all'], correct: 1, explain: 'Peripheral regions typically receive less investment and have lower population density and service provision compared to the core.', misconception: 'Peripheral does not mean "empty" \u2014 it means relatively less developed and less densely populated compared to the core region, not devoid of people.', tag: 'Core and periphery' },
    { q: 'Which is most likely to be a push factor driving migration to Bangkok?', options: ['Better job opportunities in Bangkok', 'Limited rural employment opportunities', 'Bangkok\u2019s entertainment options', 'Bangkok\u2019s international airport'], correct: 1, explain: 'Limited employment opportunities in rural, peripheral areas is a push factor \u2014 it drives people away from their origin.', misconception: 'Attractive features of the destination (like jobs or entertainment in Bangkok) are pull factors, not push factors, even though they relate to the same migration.', tag: 'Push and pull factors' },
...
window.SBL_LESSONS.CP04 = {
  ...
  readinessQuestions: [
    ...
    { q: 'The Aswan High Dam is significant to Egypt because it:', options: ['Created a new desert region', 'Controls the Nile\u2019s flow and supports irrigation', 'Is the country\u2019s largest city', 'Marks the southern border with Sudan only'], correct: 1, explain: 'The Aswan High Dam regulates the Nile\u2019s flow, supporting irrigation and reducing flooding, shaping settlement patterns.', misconception: 'The dam is sometimes mistaken for a settlement or border feature rather than understood as major water-management infrastructure shaping where people can farm and live.', tag: 'Egypt overview' },
    { q: 'How does economic development in Thailand compare with Egypt in terms of distribution?', options: ['Both show no link between development and distribution', 'Both show population concentrating around the main economic core', 'Thailand\u2019s population avoids its core city', 'Egypt\u2019s population avoids the Nile'], correct: 1, explain: 'In both countries, population concentrates strongly around the main economic centre \u2014 Bangkok in Thailand and the Nile Valley/Cairo in Egypt.', misconception: 'Students sometimes think development patterns must differ dramatically between very different countries, when the underlying core-concentration principle is actually similar.', tag: 'Economic development' },
...
window.SBL_LESSONS.CP05 = {
  ...
  quiz: [
    ...
    { q: 'A common limitation of the DTM is that it:', options: ['Applies perfectly to every country', 'Was based on the experience of Western European countries', 'Cannot be used to explain any country', 'Only applies to Africa'], correct: 1, explain: 'The DTM was developed from the historical experience of Western European countries, so it does not perfectly predict every country\u2019s pattern.', misconception: 'The DTM is sometimes treated as a universal law rather than a generalised model with real limitations for countries that developed differently.', tag: 'Strengths and limitations' },
    { q: 'Total fertility rate (TFR) measures:', options: ['The number of births per 1,000 people', 'The average number of children a woman would have in her lifetime', 'The number of deaths per 1,000 people', 'The total population of a country'], correct: 1, explain: 'TFR estimates the average number of children a woman would have over her reproductive lifetime, based on current birth rates.', misconception: 'TFR is often confused with crude birth rate; TFR is per woman over a lifetime, while crude birth rate is per 1,000 people per year.', tag: 'Fertility rate' },
    ...
    { q: 'In DTM Stage 5, some demographers argue that a country may experience:', options: ['Rapid population growth', 'Natural decrease, where deaths exceed births', 'The highest birth rate of any stage', 'No demographic change at all'], correct: 1, explain: 'Some models extend the DTM to a Stage 5, where very low fertility can cause natural decrease as deaths exceed births.', misconception: 'Stage 5 is sometimes forgotten or confused with Stage 4 (stable, low growth); the key difference is Stage 5 can show actual population decline.', tag: 'Stages 1 to 5' },
    { q: 'A key cause of fertility decline in many developing countries has been:', options: ['Declining access to education for women', 'Increased access to education and employment for women', 'Rising infant mortality', 'Government bans on all healthcare'], correct: 1, explain: 'Increased education and employment opportunities for women are strongly linked to declining fertility rates worldwide.', misconception: 'It is sometimes wrongly assumed that fertility decline is driven mainly by government force, when broader social and economic changes (like education) are the dominant global driver.', tag: 'Fertility decline' },
    { q: 'Life expectancy is best defined as:', options: ['The average age people currently are', 'The average number of years a newborn is expected to live', 'The maximum possible human age', 'The retirement age in a country'], correct: 1, explain: 'Life expectancy is a statistical estimate of the average number of years a newborn can expect to live, based on current mortality patterns.', misconception: 'Life expectancy is sometimes confused with the maximum lifespan or current average age of the population, rather than a forward-looking statistical estimate.', tag: 'Demographic indicators' }
  ]
};
...
window.SBL_LESSONS.CP06 = {
  ...
  quiz: [
    ...
    { q: 'The Gambia\u2019s population structure is best described as:', options: ['Ageing, with low fertility', 'Youthful, with high fertility', 'Declining in total size', 'Identical to Thailand\u2019s'], correct: 1, explain: 'The Gambia remains at an earlier stage of demographic transition with a young, fast-growing population.', misconception: 'It is a common error to assume all countries follow demographic transition at the same pace; the Gambia and Thailand are at very different stages.', tag: 'The Gambia' },
...
window.SBL_LESSONS.CP07 = {
  ...
  quiz: [
    ...
    { q: 'Which is a common economic consequence of megacity growth?', options: ['Increased economic opportunity and productivity concentrated in the city', 'Guaranteed equal income for all residents', 'A total absence of informal employment', 'No effect on national GDP'], correct: 0, explain: 'Megacities often concentrate economic opportunity and productivity, contributing significantly to national GDP, even alongside inequality.', misconception: 'It is easy to focus only on the negative consequences of megacities and overlook that they also concentrate significant economic opportunity and output.', tag: 'Economic consequences' },
    { q: 'A common environmental consequence of rapid megacity growth is:', options: ['Improved air quality', 'Increased air and water pollution', 'A reduction in waste production', 'No change to local ecosystems'], correct: 1, explain: 'Rapid, often unplanned growth strains infrastructure, commonly leading to increased air and water pollution.', misconception: 'Some students assume environmental impact is limited to rural areas; rapid urban growth creates significant, concentrated environmental pressures too.', tag: 'Environmental consequences' },
    { q: 'Rural-to-urban migration towards megacities is often driven by:', options: ['A desire to reduce access to services', 'The search for employment and better opportunities', 'Government bans on rural life', 'Random chance'], correct: 1, explain: 'People commonly migrate to megacities in search of employment, education and improved access to services.', misconception: 'Migration decisions are sometimes portrayed as random or forced, when in most megacity contexts they reflect a genuine search for economic opportunity.', tag: 'Migration and natural increase' },
...
window.SBL_LESSONS.CP08 = {
  ...
  quiz: [
    ...
    { q: 'Political push factors that can cause forced migration include:', options: ['Persecution based on ethnicity or religion', 'Better job availability elsewhere', 'A desire for a change of climate', 'Access to better shopping facilities'], correct: 0, explain: 'Persecution based on ethnicity, religion or political belief is a classic political push factor forcing people to flee.', misconception: 'Push factors relating to lifestyle preference (climate, shopping) are sometimes confused with the serious political and safety-related push factors behind forced migration.', tag: 'Political push factors' },
    { q: 'A consequence for Burma (Myanmar) itself following the Rohingya displacement has been:', options: ['International criticism and scrutiny', 'Universal international praise', 'No diplomatic consequences at all', 'Increased tourism revenue'], correct: 0, explain: 'Burma has faced significant international criticism and diplomatic scrutiny in response to the treatment and displacement of the Rohingya.', misconception: 'It is sometimes assumed that displacement crises have no consequences for the country of origin, but they often carry major diplomatic and reputational consequences.', tag: 'Consequences for Burma' },
    { q: 'A key consequence for displaced Rohingya people has been:', options: ['Guaranteed immediate citizenship in host countries', 'Loss of home, livelihood, and access to basic services', 'Improved legal status compared to before displacement', 'No change to daily life'], correct: 1, explain: 'Displaced Rohingya people have commonly lost their homes, livelihoods and access to basic services and legal protections.', misconception: 'Displacement is sometimes assumed to quickly resolve into stable new citizenship, when in reality many displaced people face prolonged uncertainty and hardship.', tag: 'Consequences for people' },
    { q: 'Which best distinguishes forced migration from voluntary migration?', options: ['Forced migration always involves crossing an ocean', 'Forced migration happens due to compulsion, such as persecution or conflict, not free choice', 'Voluntary migration never has any push factors', 'There is no real difference between the two'], correct: 1, explain: 'Forced migration occurs due to compulsion \u2014 people are made to leave through persecution, conflict or disaster \u2014 rather than through free choice.', misconception: 'The line between forced and voluntary migration is sometimes oversimplified; the key distinction is the presence of genuine compulsion, not the distance travelled.', tag: 'What is forced migration?' },
...
window.SBL_LESSONS.CP12 = {
  ...
  quiz: [
    ...
    { q: 'A common way gender inequality is measured is:', options: ['The Gender Inequality Index (GII)', 'Total population size', 'Average annual rainfall', 'Coastline length'], correct: 0, explain: 'The Gender Inequality Index (GII) is a widely used measure combining indicators such as reproductive health, empowerment and labour market participation.', misconception: 'Unrelated physical statistics are sometimes mistaken for social indicators; gender inequality is measured through specific composite indices like the GII, not physical geography data.', tag: 'How inequality is measured' },
...
window.SBL_LESSONS.CP13 = {
  ...
  quiz: [
    ...
    { q: 'To benefit from a demographic dividend, a country generally needs:', options: ['A shrinking working-age population', 'Falling fertility alongside investment in education, health and jobs', 'No investment in education', 'A rapidly ageing population only'], correct: 1, explain: 'Realising the dividend requires falling fertility combined with strong investment in education, health and employment.', misconception: 'A favourable age structure alone is sometimes assumed to be sufficient; without investment in jobs and education, the potential dividend is not automatically realised.', tag: 'Conditions needed' },
    { q: 'The "first" demographic dividend refers to:', options: ['Economic growth from a larger working-age share of the population', 'Growth driven entirely by increased saving among the elderly', 'A decline in the total population', 'The effects of an ageing population'], correct: 0, explain: 'The first dividend comes from having a larger share of the population in working age relative to dependents.', misconception: 'First and second dividends are sometimes confused; the first is about the working-age share of the population, while the second relates more to capital and savings accumulation.', tag: 'First demographic dividend' },
